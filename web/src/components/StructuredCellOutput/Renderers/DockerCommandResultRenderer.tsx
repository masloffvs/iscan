...
import { type DockerCommandResultValue, type BpkgResultTabId } from "../types";
...
export default function DockerCommandResultRenderer({
  value,
  onTableSelectionCopyTextChange,
}: {
  value: DockerCommandResultValue;
  ...
  }, [defaultTab, value.commandString, value.cwd.logicalPath, value.exitCode]);
  ...
  switch (activeTab) {
    case "parsed":
      tabContent = value.parsed !== undefined
        ? <StructuredCellOutputRoot value={value.parsed} onTableSelectionCopyTextChange={onTableSelectionCopyTextChange} />
        : null;
      break;
    case "stdout":
